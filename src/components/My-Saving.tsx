        ...
        <div className="flex  flex-col  items-start justify-start "> 
            ...
            <div  className="container bg-[#333333] rounded-2xl ">
             <ul className="items-center justify-start flex flex-col">
                <li className="h-10 w-52 flex items-center gap-3 text-slate-50 "><span className="justify-start ml-4 gap-x-4 bg-[#5151F9] rounded-3xl">..</span>Wedding</li>
                ...
                <button className="h-10 w-52  hover:bg-[#5172f9cc] hover:text-white rounded-3xl activ:bg-[#5151F9]"><span className=" h-8  bg-[#5151F9] ml-4 ">+</span> Add saivings </button>
            </div>
        </div>
    )
